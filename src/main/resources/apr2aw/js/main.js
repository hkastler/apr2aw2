...
function drawChart() {
    ...
    var weightLossPerWeek = parseFloat(weightLossPerWeekAry[0]);
    ...
    for (i = dayRangeStart; i <= dayRangeEnd; i++) {
        ...
        for (j = 0; j < weightLossPerWeekAry.length; j++) {
            col = col + 1;
            var weightLossPerWeek = parseFloat(weightLossPerWeekAry[j]);
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    document.getElementById('twoWeekView').addEventListener('click', function () {
        daySpread(7);
    }, true);
    ...
    document.getElementById('dayRangeStartDate').addEventListener('input', function () {
        getRangeChart();
    }, true);
    document.getElementById('dayRangeEndDate').addEventListener('input', function () {
        getRangeChart();
    }, true);
